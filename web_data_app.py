...
def book_data():
    ...
    salePrices = []
    for price in prices:
        salePrices.append(price - ((25/100) * price))
    
    # Create a DataFrame using the two lists
    book_data = pd.DataFrame(list(zip(titles, prices, salePrices)), columns=['Titles','Prices','Sale Prices'])    
...
def learn():
    ...
    return "I learned to use Python with useful utilities like Numpy and Pandas which make data analysis easy."
